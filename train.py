...
def main(_):
    ...
    data_dir = 'data'
    tfrecord_train = 'aoi_7_pattern_299_0625_train.tfrecords'
    ...
    with tf.Graph().as_default():
        ...
        with slim.arg_scope(inception_resnet_v2.inception_resnet_v2_arg_scope()):
            logits, end_points = inception_resnet_v2.inception_resnet_v2(float_image_batch, num_classes=num_classes, is_training=True)
